...
namespace AdminMVC.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(AdminMvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserName,UserPassword,UserRole,UserEmail,CreatedAt")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,UserName,UserPassword,UserRole,UserEmail,CreatedAt")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
